...
const InvoiceDetail = () => {
    ...
    useEffect(() => {
        const fetchInvoice = async () => {
            try {
                ...
                // Bill From
                setBusinessName(invoice.billFrom?.businessName || '');
                setEmail(invoice.billFrom?.email || '');
                setAddress(invoice.billFrom?.address || '');
                setPhone(invoice.billFrom?.phoneNumber || '');

                // Bill To
                setClientName(invoice.billTo?.clientName || '');
                setClientEmail(invoice.billTo?.email || '');
                setClientAddress(invoice.billTo?.address || '');
                setClientPhone(invoice.billTo?.phoneNumber || '');
    ...
    const calculateItemTotal = (item) => {
        ...
        const taxAmount = (baseTotal * item.tax) / 100;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Make API call (PUT)
            await axiosInstance.put(API_PATHS.INVOICE.UPDATE_INVOICE(id), invoiceData);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6 md:mb-8">
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Edit Invoice</h1>
