...
const NewInvoice = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Make API call
            const response = await axiosInstance.post(API_PATHS.INVOICE.CREATE, invoiceData);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6 md:mb-8">
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Create New Invoice</h1>
